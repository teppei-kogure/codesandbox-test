 ...
 * 三項演算子
 */
// ある条件 ?　条件がtruneの時： falseの時
// const val1 = 1 < 0 ? "trune です" : "falseです";
// console.log(val1);
...
// const checkSum = (num1, num2, threshold = 100) => {
//   return num1 + num2 >= threshold
//     ? `${threshold}を超えています`
//     : "許容範囲内です";
// };
// console.log(checkSum(79, 20, 10));
